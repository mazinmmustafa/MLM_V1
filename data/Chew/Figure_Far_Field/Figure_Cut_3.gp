...
plot '../data_far_field_M_.txt' using (pi/2-$1):($4 > r_min ? $4 : r_min) with lines lw 2 dt 1 lt 6 title '$\phi=0$',\
     '../data_far_field_M_.txt' using (pi/2-$1):($5 > r_min ? $5 : r_min) with lines lw 2 dt 1 lt 7 title '$\phi=\pi/2$'