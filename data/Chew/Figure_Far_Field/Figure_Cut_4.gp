...
set title '$|E_{\theta}|$ [dB]'

plot '../data_far_field_M_.txt' using (pi/2-$1):($2 > r_min ? $2 : r_min) with lines lw 2 dt 1 lt 6 title '$\phi=0$',\
     '../data_far_field_M_.txt' using (pi/2-$1):($3 > r_min ? $3 : r_min) with lines lw 2 dt 2 lt 7 title '$\phi=\pi/2$'