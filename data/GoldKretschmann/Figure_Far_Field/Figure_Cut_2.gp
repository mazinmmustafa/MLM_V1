...
plot '../data_near_far_M_.txt' using (pi/2-$1):($2 > r_min ? $2 : r_min) with lines lw 2 dt 1 lt 6 title '$|E|$ [dB]: Near-Field',\
     '../data_near_far_M_.txt' using (pi/2-$1):($3 > r_min ? $3 : r_min) with lines lw 2 dt 1 lt 7 title '$|E|$ [dB]: Far-Field'