...
extern "C" void dunavant_rule_wrapper_(size_t *rule, size_t *order_num, double *x, double *y, double *w);
...
complex_t quadl_domain_t::quadl_1d_(complex_t (*func)(const complex_t, void*), 
    ...
    real_t error=abs(I_n-I_p);
    size_t k1=k, k2=k;
    if (error>this->tol_1d*abs(I_n)&&error>0.0){
        k++;
...
complex_t quadl_domain_t::integral_1d(complex_t (*func)(const complex_t, void*), 
    void *args, const line_domain_t line, size_t &flag){
    flag = false;
    size_t k=0;
...
complex_t quadl_domain_t::quadl_2d_(complex_t (*func)(const complex_t, const complex_t, void*), 
    ...
    //
    triangle_1.v1 = m23; 
    triangle_1.v2 = triangle.v1; 
    triangle_1.v3 = triangle.v2;
    //
    triangle_2.v1 = m23; 
    triangle_2.v2 = triangle.v3;
    triangle_2.v3 = triangle.v1; 
    //
...
complex_t quadl_domain_t::integral_2d(complex_t (*func)(const complex_t, const complex_t, void*), 
    void *args, const triangle_domain_t triangle, size_t &flag){
    flag = false;
    size_t k=0;
...
complex_t quadl_domain_t::quadl_3d_(complex_t (*func)(const complex_t, const complex_t, const complex_t, void*), 
    ...
    //
    tetrahedron_1.v1 = m24; 
    tetrahedron_1.v2 = m23; 
    tetrahedron_1.v3 = tetrahedron.v2; 
    tetrahedron_1.v4 = tetrahedron.v1; 
    //
    tetrahedron_2.v1 = m23; 
    tetrahedron_2.v2 = m34; 
    tetrahedron_2.v3 = tetrahedron.v3; 
    tetrahedron_2.v4 = tetrahedron.v1; 
    //
    tetrahedron_3.v1 = m34; 
    tetrahedron_3.v2 = m24; 
    tetrahedron_3.v3 = tetrahedron.v4; 
    tetrahedron_3.v4 = tetrahedron.v1; 
    //
    ...
    if (error>this->tol_3d*abs(I_n)&&error>0.0){
        k++;
...
complex_t quadl_domain_t::integral_3d(complex_t (*func)(const complex_t, const complex_t, const complex_t, void*), 
    void *args, const tetrahedron_domain_t tetrahedron, size_t &flag){
    flag = false;
    size_t k=0;
